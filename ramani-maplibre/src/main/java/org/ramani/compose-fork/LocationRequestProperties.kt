 ...
 */
package org.ramani.`compose-fork`

import android.os.Parcelable
import kotlinx.parcelize.Parcelize
import org.ramani.`compose-fork`.LocationPriority.PRIORITY_BALANCED_POWER_ACCURACY
import org.ramani.`compose-fork`.LocationPriority.PRIORITY_HIGH_ACCURACY
import org.ramani.`compose-fork`.LocationPriority.PRIORITY_LOW_POWER
import org.ramani.`compose-fork`.LocationPriority.PRIORITY_NO_POWER
